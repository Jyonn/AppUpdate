"""
Django settings for AppUpdate project.
...
SECRET_KEY = '0(z+9ufi87y#gx=2*ipjmsjc55=+9bwam%biyc%q5ne#1q*om5'
...
WSGI_APPLICATION = 'AppUpdate.wsgi.application'
